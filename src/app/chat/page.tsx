        ...
        <header className="flex items-center justify-between border-b-2 border-amber-500 bg-white px-4 py-3">
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex h-8 w-8 items-center justify-center rounded-full bg-amber-500"
            >
              ...
              <div className="space-y-5">
                ...
                {loading && (
                  <div className="flex justify-start">
                    <div className="mr-2 mt-1 flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-amber-100 text-xs">
                      🤖
                    </div>
